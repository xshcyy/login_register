...
def send_email(email, code):
    ...
    subject = '来自www.login_register.com的注册确认邮件'

    text_content = '''感谢注册www.login_register.com，这里专注于Python和Django的技术的分享！\
                    如果你看到这条消息，说明你的邮箱服务器不提供HTML链接功能，请联系管理员！'''
    html_content = '''
                    <p>感谢注册<a href="http://{}/confirm/?code={}" target=blank>www.login_register.com</a>，\
